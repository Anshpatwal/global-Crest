        ...
        <section className="max-w-7xl mx-auto px-6 py-16 grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-6">
              {[
                { icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8', title: 'Email', info: 'contact@globalcrestexports.com' },
                { icon: 'M3 5v4h18V5M3 12h18m-18 5h18', title: 'Phone', info: '+91 79 1234 5678' },
                { icon: 'M12 2l3 7H9l3-7zm0 5v15', title: 'Address', info: '701, Export Tower, Ahmedabad, Gujarat 380054' },
              ].map(({ icon, title, info }) => (
