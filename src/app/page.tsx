...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-indigo-50">
      ...
      {/* <Head>
        <title>GlobalCrest Exports | Trusted Exporters from India</title>
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        {/* Content */}
        <div className="relative z-10 flex flex-col items-center text-center px-6 md:px-12 max-w-4xl space-y-8 mt-[-5vh]">
          ...
          <p className="text-lg md:text-2xl text-gray-200 font-light leading-relaxed max-w-2xl">
            We are certified exporters delivering top-quality textiles, farm produce, and machinery to global markets.
          </p>
          <div className="pt-4">
            <a
              href="products"
            ...
            {products.map((product, index) => (
              <article key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <button className="w-full bg-indigo-100 text-indigo-600 px-4 py-2 rounded-lg hover:bg-indigo-200 transition-colors">
            ...
            <div className="space-y-4 mt-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-indigo-100">contact@globalcrestexports.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-white/10 p-3 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-indigo-100">Ahmedabad, Gujarat, India</p>
                </div>
              </div>
            </div>
          </div>
...
const products = [
  ...
  {
    name: 'Basmati Rice',
    description: '1121 Steam Basmati Rice with competitive FOB pricing',
    image: 'https://images.unsplash.com/photo-1586201375761-83865001e31c'
  },
  {
    name: 'Machinery Parts',
    description: 'Industrial-grade components for manufacturing',
...
const whyChooseUs = [
  {
    ...
    description: 'Established network in 50+ countries',
    icon: 'https://img.icons8.com/ios-filled/50/1A73E8/time-machine.png'
  },
  {
  ...
  },
  {
    ...
    description: 'From sourcing to final delivery',
    icon: 'https://img.icons8.com/ios-filled/50/1A73E8/shipped.png'
  }
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'MOQ varies by product. For textiles: 5000 meters, Agricultural products: 20 MT container loads.'
  },
  {
    id: 3,
